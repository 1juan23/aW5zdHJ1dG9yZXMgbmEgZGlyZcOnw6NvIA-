...
export function SocialLogin({ mode, disabled }: SocialLoginProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-card px-2 text-muted-foreground">
            {mode === "login" ? "ou entre com" : "ou cadastre com"}
          </span>
        </div>
      </div>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full gap-3 h-11 font-medium hover:bg-muted/50 transition-all"
